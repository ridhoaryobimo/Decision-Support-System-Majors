...
class My_model extends CI_Model {
	...
	{
		$this->db->order_by('id_unggulan','asc');
		// $this->db->where('id_unggulan', $this->session->userdata('unggulan'));
		$query = $this->db->get('unggulan');
		return $query->result();
	}
	...
	public function hasil_seleksi()
	{
		...
		// $this->db->join('unggulan','unggulan.id_unggulan = hasil_seleksi.id_unggulan','left');
		$this->db->order_by('hasil_seleksi.vektor_s','desc');
		$query = $this->db->get();
		return $query->result();
	}

	public function hasil_seleksi_unggulan_ku()
	{
		$this->db->select('*');
		$this->db->from('hasil_seleksi');
		$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','left');
	...
	// public function hasil_seleksi_unggulan_ipa()
	// {
	// 	$this->db->select('*');
	// 	$this->db->from('hasil_seleksi');
	// 	$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','left');
	...
	// public function hasil_seleksi_unggulan_ips()
	// {
	// 	$this->db->select('*');
	// 	$this->db->from('hasil_seleksi');
	// 	$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','left');
	...
	public function hasil_seleksi_final_ku()
	{
		$this->db->select('*');
		$this->db->from('hasil_seleksi');
		$this->db->join('siswa','siswa.id_siswa = hasil_seleksi.id_siswa','left');
		...
		// $this->db->join('unggulan','unggulan.id_unggulan = hasil_seleksi.id_unggulan','left');
		$this->db->order_by('hasil_seleksi.vektor_v','desc');
		// $this->db->where('hasil_seleksi.id_unggulan',1);
		$query = $this->db->get();
		return $query->result();
	}
	...
	// 	$this->db->join('nilai','nilai.id_siswa = siswa.id_siswa','left');
	// 	$this->db->join('unggulan','unggulan.id_unggulan = hasil_seleksi.id_unggulan','right');
	// 	$this->db->where('hasil_seleksi.id_unggulan',2);
	// 	$this->db->order_by('hasil_seleksi.vektor_v_ipa','desc');
	// 	$query = $this->db->get();
	// 	return $query->result();
	// }
	...
	// 	$this->db->join('nilai','nilai.id_siswa = siswa.id_siswa','left');
	// 	$this->db->join('unggulan','unggulan.id_unggulan = hasil_seleksi.id_unggulan','left');
	// 	$this->db->where('hasil_seleksi.id_unggulan',3);
	// 	$this->db->order_by('hasil_seleksi.vektor_v_ips','desc');
	// 	$query = $this->db->get();
	// 	return $query->result();
	// }
	...
	public function hasil_seleksi_siswa()
	{
		...
		$this->db->join('nilai','nilai.id_siswa = siswa.id_siswa','left');
		// $this->db->join('unggulan','unggulan.id_unggulan = hasil_seleksi.id_unggulan','left');
		if ($this->input->get('unggulan')) {
			$this->db->where('hasil_seleksi.id_unggulan', $this->input->get('unggulan'));
		}
	...
	public function detail()
	{
		...
		$this->db->order_by('siswa.id_siswa','desc');
		$this->db->where('nilai.nilai_psikotest !=','');
		if ($this->session->userdata('unggulan')) {
			$this->db->where('siswa.ujian_unggulan', $this->session->userdata('unggulan'));
		}
		$query = $this->db->get();
		return $query->result();
	}
